...
class Profile:
    ...
    get_sent returns the list object containing all messages that have been sent and added to the Profile object

    """
    def get_sent(self) -> list[Post]:
        return self.sent
